        ...
        <div className='bg-white p-3 rounded w-25'>
         <form action ="">
            ...
            <div className='mb-3'>
                ...
                <input type="address" placeholder='Enter Address' className='form-control rounded-0'/>
            </div>
            <div className='mb-3'>
            ...
            <div className='mb-3'>
                ...
                <input type="SQ" placeholder='Enter Secret Question' className='form-control rounded-0'/>
            </div>
